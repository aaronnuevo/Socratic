...
const g = globalThis;
if (!g.__socraticSynthesizeSessionStore) {
  g.__socraticSynthesizeSessionStore = new SynthesizeSessionStore();
}
export const synthesizeSessionStore = g.__socraticSynthesizeSessionStore;
