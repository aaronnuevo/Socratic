...
const g = globalThis;
if (!g.__socraticComposeSessionStore) {
  g.__socraticComposeSessionStore = new ComposeSessionStore();
}
export const composeSessionStore = g.__socraticComposeSessionStore;
