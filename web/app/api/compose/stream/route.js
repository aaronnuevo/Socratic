...
export async function GET(req) {
  ...
  const sess = composeSessionStore.getSession(sessionId);
  if (!sess) {
  ...
  const close = () => {
    ...
    try { composeSessionStore.removeClient(sessionId, writer); } catch {}
